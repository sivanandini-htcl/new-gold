        ...
        <div className=" grid md:grid-cols-2 gap-4">
         ...
         />
          ...
          <div className="relative z-10 flex flex-col justify-between h-full p-5">
            ...
            <p className="text-[10px] uppercase tracking-[0.12em] text-white/40 mb-1">Current Value</p>
              <p className="text-[10px] uppercase tracking-[0.12em] text-white/40 mb-1">Holdings</p>
                </div>
      ...
      <div className="flex gap-3 mb-6 overflow-auto">
        ...
        >
         ...
         <button
          ...
          className="px-5 py-2 rounded-xl bg-primary text-background border border-white/10 text-sm">
          Review Sell
        </button>
