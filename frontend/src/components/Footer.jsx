...
function Footer() {
  ...
  return (
    <footer className="w-full bg-[#111117]">
      <div className="max-w-7xl 2xl:max-w-full mx-auto ml-4 p-3 px-4 py-10 grid grid-cols-1 sm:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col ">
          <div className="flex items-center gap-0 2xl:gap-1 mb-2">
            ...
            {/* <h1 className="text-xl md:text-xl lg:text-2xl xl:text-4xl 2xl:text-6xl font-bold leading-none">
              <span className="bg-gradient-to-r from-yellow-700 via-yellow-200 to-yellow-800 bg-clip-text text-transparent font-body">DGI</span>
          ...
          <p className="text-xs 2xl:text-2xl leading-relaxed text-yellow-100/80 mb-4">
        ...
        {/* Column 2 — My Account */}
        <div>
          <p className="text-xs uppercase tracking-widest font-medium 2xl:text-2xl text-yellow-100/80 mb-4">
            My Account
          </p>
        ...
        <div>
          ...
          <ul className="space-y-3 text-yellow-100/80 2xl:text-2xl  text-xs md:text-sm">
        ...
        {/* Column 4 — Contact */}
        <div>
          <p className="text-xs uppercase tracking-widest 2xl:text-2xl font-medium text-yellow-100/80 mb-4 2xl:mt-0">
            Contact Us
          </p>
