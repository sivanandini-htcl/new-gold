    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div 
          ...
          initial="initial"
          animate="animate"
          className="mb-12 bg-gradient-to-br from-[#1a1508] via-[#523e1b] to-[#141414] border-b border-yellow-300/40 shadow-md p-3 rounded-2xl"
        >
          <div className="flex justify-between items-center mb-5">
            <div>
              <h2 className="font-serif text-2xl bg-gradient-to-r from-yellow-600 via-yellow-500 to-yellow-700 bg-clip-text text-transparent  mb-0 font-bold">
...
/>
        ...
        <motion.div 
          ...
          initial="initial"
          animate="animate"
          className="mb-12 bg-gradient-to-br from-[#1a1508] via-[#5a4118] to-[#141414] border-b border-yellow-300/40 shadow-md p-3 rounded-2xl"
        >
          <div className="flex justify-between items-center mb-5">
            <div>
              <h2 className="font-serif text-2xl text-gray-400 mb-0 font-bold">
                Featured Silver Collection
              </h2>
              <p className="text-xs text-gray-400 mt-1 mb-0">Handpicked silver pieces for every occasion</p>
            </div>
            <motion.button
              whileHover={{ scale: 0.98 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate("/redeem")}
              className="flex items-center gap-1.5 bg-transparent border-2 border-gray-400 rounded-lg px-4 py-2 font-serif text-xs text-gray-400 cursor-pointer font-bold"
            >
              View All <ChevronRight size={14} />
            </motion.button>
          </div>
    <ProductCarousel
  products={featuredSilver}
  renderCard={(product) => (
    <ProductCard product={product} navigate={navigate} />
  )}
/>
