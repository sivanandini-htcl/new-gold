...
function Cart() {
  const { cartItems, fetchCart, removeFromCart, updateQuantity } =
    useCartStore();
...
const [checkoutLoading, setCheckoutLoading] = useState(false);
  // Detect cart type
const hasMetalItems = cartItems.some(
  (item) => item.type === "METAL"
);

const hasGold = cartItems.some(
  (item) => item.type === "METAL" && item.metalType === "GOLD"
);

const hasSilver = cartItems.some(
  (item) => item.type === "METAL" && item.metalType === "SILVER"
);

  const hasProductItems = cartItems.some(
              ...
              <div className="divide-y divide-yellow-700/10">
                ...
                {cartItems.map((item) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="flex gap-4 p-4 sm:p-5  transition"
                    >
                      ...
                      >
                        {item.image ? (
                          ...
                          <div className="flex flex-col items-center justify-center w-full h-full bg-gradient-to-br from-amber-100 to-amber-50">
                            <span className="text-2xl 2xl:text-4xl text-yellow-600">
                              ◈
                            </span>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-start justify-between gap-2 mb-1">
                          ...
                          <div className="flex items-center gap-2 min-w-0">
                            ...
                            <h3 className="text-sm sm:text-base 2xl:text-2xl font-semibold font-serif text-primary truncate">
                              {item.name}
                            </h3>
                ...
                {cartItems.map((item) => (
                  ...
                  >
                    <span className="text-xs 2xl:text-xl text-primary/70 flex-1 leading-relaxed">
                      ...
                      <span className="text-primary/50 ml-1 2xl:text-xl">
                        ×{item.quantity}
                      </span>
                    </span>
                ...
                <div className="flex items-center justify-center gap-4 pt-1">
                  ...
                  {[
                    ...
                    >
                      ...
                      <span className="text-xs text-primary/70 font-serif">
                        {text}
                      </span>
                    </div>
                  ))}
