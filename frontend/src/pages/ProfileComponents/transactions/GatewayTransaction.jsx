// src/pages/GatewayTransaction.jsx
...
export default function GatewayTransaction() {
...
useEffect(() => {
  ...
  ? transactions.filter((t) => {
      const typeOk = filter === "all" || t.transactionType === filter;
...
//   if (error) {
//     return (
//       <div className="min-h-screen bg-[#1a1a23] flex items-center justify-center px-6">
//         <div className="text-center">
//           <p className="text-errorLight text-lg font-semibold mb-2">
...
//             className="px-5 py-2 rounded-xl bg-primaryGoldGradient text-black font-semibold"
//           >
//             Retry
//           </button>
//         </div>
...
//   }
  ...
  Back to Dashboard
      ...
      <div className="max-w-[700px] mx-auto px-4 pt-1">
