...
const onSubmit = async (data) => {
  ...
  return (
    <div style={{ fontFamily: "'Syne', sans-serif" }} className="min-h-screen bg-[#0f0f17] flex flex-col items-center py-10 px-4">
      ...
      <div className="w-full max-w-sm flex flex-col gap-5">
        ...
        <div className="relative w-full h-52 rounded-2xl overflow-hidden bg-[#0a0a12]">
         ...
         />
          ...
          <div className="relative z-10 flex flex-col justify-between h-full p-5">
            ...
            <div>
              <p className="text-[10px] uppercase tracking-[0.12em] text-white/40 mb-1">Available Balance</p>
              <div className="flex items-center gap-2.5">
                <span className="text-3xl font-bold text-white tracking-tight" >
                  {balanceVisible ? '₹ 12,345.00' : '₹ ••••••'}
                </span>
        ...
        {showWithdraw && (
          <div className="flex flex-col gap-3 bg-white/5 border border-white/10 rounded-2xl p-4">
            <p className="text-[10px] uppercase tracking-[0.12em] text-white/40 font-semibold">Withdrawal Amount</p>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="border border-white/10 rounded-2xl overflow-hidden bg-white/[0.03]">
                ...
                return (
                  ...
                  >
                    <div className={`w-10 h-10 rounded-xl border flex items-center justify-center flex-shrink-0
                      ...
                      <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke={isSelected ? '#c9a84c' : '#888'} strokeWidth="2">
              ...
              <button
                ...
                <div className="w-10 h-10 rounded-xl border border-dashed border-white/20 flex items-center justify-center text-lg text-white/30">+</div>
                Add Bank Account
              </button>
            </div>
          </div>
